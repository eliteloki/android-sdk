...
public class SocialCall<T, E extends Exception> {

    private final Converter<T, E> converter;
    /* Underlying okhttp call */
    private okhttp3.Call rawCall;
    public SocialCall(okhttp3.Call rawCall, Converter<T, E> converter) {
    ...
    public void setUserDetails(T response){
        ...
        Hasura.setUserToken(socialLoginResponse.getSessionId());
        Hasura.setUserId(socialLoginResponse.getHasuraId());
    }
